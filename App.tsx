        ...
        <div className="space-y-20 pb-20">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           ...
           <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                {[
                  { title: 'Sarees', view: AppView.SAREES, img: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?auto=format&fit=crop&q=80&w=800', desc: 'Banarasi, Silk, & Dyed' },
